    ...
    while try_cnt <= max_try:
        ...
        if len(user_input) != max_dig or not user_input.isdecimal():
            if try_cnt == 1:
                ...
                print('خواهش می کنم عدد وارد کن!')
                try_cnt += 1
            elif try_cnt == 3:
            ...
            if try_cnt > max_try:
                ...
                print(' تا دیداری دیگر، خدا یار و یاورت!')
                return 0
        else:
            return user_input
...
print('Are you ready to play this game? :) [y/n] ')
ready = input('>: ')

if ready == 'n':
    print('حاجی گرفتی مارو؟ :/')
    time.sleep(2)
    print('نه خدایی گرفتی مارو؟ :/')
    sys.exit()
else:
    main()